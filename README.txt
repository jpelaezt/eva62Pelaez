...
a persistence unit "eva62PelaezPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Pelaez/pom.xml":
...
artifact ("eva62Pelaez.war") is already built. You can build
